...
const ChatInput = ({ onSendMessage, setIsLoading = noop, autoFocusTrigger, conversationId }) => {
  ...
  console.log("Full navigateData object:", JSON.stringify(navigateData, null, 2));
  ...
  // Show message then redirect
    ...
    onSendMessage(null, navigateData[0].message);
setTimeout(() => {
  window.location.href = navigateData[0].redirectUrl;
}, 1500);
